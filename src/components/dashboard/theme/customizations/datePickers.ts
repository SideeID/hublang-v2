...
// Local shape for the subset of components we customize; avoids relying on augmentation types
type LocalPickerComponents = {
  MuiPickerPopper: {
    styleOverrides: {
      paper: ({ theme }: { theme: Theme }) => object;
    };
  };
  MuiPickersArrowSwitcher: {
    styleOverrides: {
      spacer: { width: number };
      button: ({ theme }: { theme: Theme }) => object;
    };
  };
  MuiPickersCalendarHeader: {
    styleOverrides: {
      switchViewButton: object;
    };
  };
  MuiMonthCalendar: {
    styleOverrides: {
  ...
  MuiPickersDay: {
    styleOverrides: {
      root: ({ theme }: { theme: Theme }) => object;
    };
  };
};

export const datePickersCustomizations: LocalPickerComponents = {
  MuiPickerPopper: {
    styleOverrides: {
